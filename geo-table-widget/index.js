...
class GeoTableWidgetElement extends WidgetBase {
    ...
    data = [];
    sortState = { column: 'totalDistanceKm', direction: 'descending' };
    paginator;
    ...
    getDataset() {
        ...
        return parseEnum(datasetAttr, ['countries', 'cities'], 'countries');
    }
    /**
    ...
    `;
        ...
        const defaultDirection = parseEnum(this.getAttribute('data-default-sort-direction'), ['ascending', 'descending'], 'descending');
    ...
    render(data) {
        ...
        const sorted = TableSorter.sort(this.data, this.sortState.column, this.sortState.direction, columnType);
    ...
    createTableHeader() {
        ...
        this.columns.forEach((col, index) => {
            ...
            const dataset = this.getDataset();
            if ((dataset === 'countries' && col.key === 'citiesCount') ||
...
window.GeoTableWidget = GeoTableWidget;
