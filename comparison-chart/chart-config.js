 ...
 */
import { Chart, BarController, BarElement, LineController, LineElement, PointElement, CategoryScale, LinearScale, Title, Tooltip, Legend, Filler } from 'chart.js';
// Register components for both bar and line charts
Chart.register(BarController, BarElement, LineController, LineElement, PointElement, CategoryScale, LinearScale, Title, Tooltip, Legend, Filler);
/**
 ...
 */
export function createYearOverYearChart(canvas, data, config) {
 ...
 */
export function createSeasonalTrendsChart(canvas, data, config) {
