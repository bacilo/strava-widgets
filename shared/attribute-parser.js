 ...
 */
export function parseBoolean(element, attrName, defaultValue = false) {
 ...
 */
export function parseColor(value, defaultValue) {
    if (!value)
        return defaultValue;
 ...
 */
export function parseEnum(value, allowedValues, defaultValue) {
    if (!value)
        return defaultValue;
    if (allowedValues.includes(value)) {
        return value;
    }
    console.warn(`Invalid enum value: "${value}", allowed: [${allowedValues.join(', ')}], using default: ${defaultValue}`);
    return defaultValue;
}
/**
 ...
 */
export function parseCSSValue(value, defaultValue) {
    if (!value)
        return defaultValue;
