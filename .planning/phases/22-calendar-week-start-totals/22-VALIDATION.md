...
**3 PASS, 0 FAIL, 2 BLOCKED, 0 NOT EXERCISABLE** across R24–R28.
...
- **R26 — BLOCKED.** The developer observed the calendar and formed a judgement ("Compaction
  ...
  never FAIL.
- **R27 — BLOCKED.** The developer reported "Theme dark is reached" after re-enabling site-data
...
- **Gap 1 (CAL-02/SC3, the 381-640px coverage band, reopened at Round 3) — STILL OPEN.** R25 PASSED
  ...
  closure rule, Gap 1 closes only if R25 AND R26 are both PASS; with R26 BLOCKED, Gap 1 stays STILL
  OPEN. The documented fallback remains the DISC-6b `.splits-scroll`-style horizontal-scroll wrapper —
  not proposed, planned or implemented here.
- **Gap 2 (CR-01, the theme toggle stuck on light under blocked storage) — STILL OPEN.** R27, the row
  ...
  once — was never established. Per house rule 12, this row may not be closed on `nav-theme.test.ts`'s
  unit evidence or on source reading, and it was not. The control's behaviour under blocked storage
  remains unobserved to the depth this round requires.
