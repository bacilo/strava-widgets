...
- [ ] 20-18-PLAN.md — full gate + BLOCKING Round 4 human checkpoint, twelve rows each with its own required detail **and** its own named observer, re-asking R18/R19 against real anchors on both tables, exercising the focus-leak sequence for the first time, and unblocking R2/R16 with a disclosed staged-data fixture (UX-01, UX-02, UX-03, REC-08)
