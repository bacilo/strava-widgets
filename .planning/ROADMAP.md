...
- [ ] **Phase 24: Local Curation Mode** - Developer can toggle whole-activity PR exclusion from a localhost-only UI, with the write path provably absent from the published bundle
