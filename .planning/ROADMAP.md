...
- [ ] **Phase 21: Overview Rebuild** - Overview's PR/activity rows, records scope toggle, headline stats, and the Current Streak "ended" label all reach the standard the rest of the dashboard sets (7/7 plans executed 2026-08-18; verification `gaps_found` — OVR-03 open, success criterion 3 not human-observed)
...
| 21. Overview Rebuild | v2.1 | 7/7 | Gaps Found | 2026-08-18 |
