...
- [ ] **Phase 17: Activity Browser & Detail Views** - Browse, filter, and drill into any archived activity with full pace/HR/cadence detail (15/15 planned plans executed 2026-08-11; 17-15's real-browser checkpoint returned PARTIAL — 2 named gaps open: route-map basemap tiles not rendering, chart-band x-axis misalignment; gap-closure planning required via `/gsd-plan-phase 17 --gaps` before this phase gate closes)
...
| 17. Activity Browser & Detail Views | v2.0 | 15/15 | Gap closure needed (PARTIAL, 2 gaps) | - |
