...
- [x] **Phase 21: Overview Rebuild** - Overview's PR/activity rows, records scope toggle, headline stats, and the Current Streak "ended" label all reach the standard the rest of the dashboard sets (completed 2026-08-18)
...
| 21. Overview Rebuild | v2.1 | 7/7 | Complete   | 2026-08-18 |
