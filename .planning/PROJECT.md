...
**v2.1 Interface Polish** — phases 19-24 complete (design system, row-click interaction, Overview rebuild, calendar week start, Trends zoom/pan, local curation mode); phase 25 (CI hardening & light-theme verification) remains.
